...
public class CustomUserStorageProvider implements ILocalCustomUserStorageProvider {
	...
	private UserEntity prepareUserEntity(final Object[] userEntity) {
		return new UserEntity((String) userEntity[0], (String) userEntity[1],
				(String) userEntity[2], (String) userEntity[3], (String) userEntity[4]);
	}
	...
	public UserModel getUserById(String id, RealmModel realm) {
		...
		System.out.println("Query in getuserbyId: " + query.toString());
	...
	public UserModel getUserByUsername(String username, RealmModel realm) {
		...
		System.out.println("Query in getuserbyname: " + query.toString());
	...
	public boolean isValid(RealmModel realm, UserModel user, CredentialInput input) {
		...
		System.out.println("Query in isValid: " + query);
	...
	public List<UserModel> getUsers(RealmModel realm, int firstResult, int maxResults) {
		...
		System.out.println("Query in getUsers: " + query);
	...
	public List<UserModel> searchForUser(String userName, RealmModel realm, int firstResult,
		...
		System.out.println("Query in searchForUser: " + query.toString());
